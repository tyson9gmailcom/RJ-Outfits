...
# Updated website code with Menu dashes, fixed navigation, and honeycomb
website_code = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    .menu-dashes { font-size: 20px; font-weight: bold; cursor: pointer; color: var(--text-charcoal); }
