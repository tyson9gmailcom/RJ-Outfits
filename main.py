...
# This block contains the 100% correct layout with the resized pentagon ribbon
website_code = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
     ...
     .product-content-wrapper { display: flex; gap: 40px; }
        ...
        /* RESIZED PENTAGON RIBBON (SIDEBAR) */
     .ribbon-sidebar {
            width: 280px; /* Reduced from 380px for a better fit */
            flex-shrink: 0; background-color: var(--primary-red); color: white;
            padding: 30px 20px; /* Adjusted padding for better spacing */
            clip-path: polygon(0 0, 85% 0, 100% 50%, 85% 100%, 0 100%);
        }
     .ribbon-title { font-size: 24px; margin-bottom: 20px; line-height: 1.1; font-weight: 700; }
     .list-features { list-style: none; }
     .list-features li { margin-bottom: 12px; display: flex; align-items: center; font-size: 15px; }
