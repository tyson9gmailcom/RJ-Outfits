...
# Updated website code with optimized ribbon size and perfect honeycomb
website_code = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
      ...
      .product-content-wrapper { display: flex; gap: 40px; }
        ...
        /* OPTIMIZED RIBBON - Reduced Horizontal Size */
      .ribbon-sidebar {
            width: 280px; flex-shrink: 0; background-color: var(--primary-red); color: white;
            padding: 30px 20px; 
            /* Recalculated clip-path for narrower width */
